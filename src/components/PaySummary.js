...
const PaySummary = ({ results, showDetails, setShowDetails }) => {
    return (
        <div className="md:col-span-1 p-4 border rounded-md bg-gray-50">
            <h2 className="text-xl font-semibold mb-4 text-brand font-heading">Pay Summary</h2>
            ...
            {results ? (
                <div className="space-y-3">
                    ...
                    <button
                        ...
                        className="mt-4 w-full py-2 bg-brand text-white rounded hover:bg-brand-dark transition"
                    >
